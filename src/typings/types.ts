...
> = MethodCoin extends Coin ? MethodCoin : ConstructorCoin extends Coin ? ConstructorCoin : never;
...
export type MethodParams<
  ...
  MethodCoin extends Coin | undefined,
  Params extends any[],
> = ConstructorCoin extends Coin ? Params : [...Params, chain: ChainOptions<MethodCoin>];
