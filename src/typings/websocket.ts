...
export type WebSocketEventCallback<TCoin extends Coin, TEvent extends WebSocketEventType> = (data: WebSocketEventPayloads<TCoin>[TEvent]) => void;

export type WebSocketEventCallbacks<TCoin extends Coin> = {
    [K in keyof WebSocketEventPayloads<TCoin>]?: Array<(data: WebSocketEventPayloads<TCoin>[K]) => void>;
};
